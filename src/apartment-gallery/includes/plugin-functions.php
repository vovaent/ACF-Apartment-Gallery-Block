 ...
 */
function acf_apartment_gallery_block_block_init() {
	register_block_type( plugin_dir_path( __FILE__ ) . '../build/block.json' );
}
add_action( 'init', 'acf_apartment_gallery_block_block_init' );
 ...
 */
function acf_apartment_gallery_block_block_categories( $block_categories ) {

	$block_categories = array_merge(
		array(
			array(
				'slug'  => 'acf-blocks',
				'title' => __( 'ACF Blocks', 'acf_apartment_gallery_block' ),
...
add_filter( 'block_categories_all', 'acf_apartment_gallery_block_block_categories' );
